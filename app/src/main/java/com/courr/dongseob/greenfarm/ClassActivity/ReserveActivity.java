            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                bt_reserve.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (item.isEmpty()){
                            Toast.makeText(ReserveActivity.this, "예약할 시간을 고르세요.", Toast.LENGTH_SHORT).show();
                        }
                        else{


                            if (Integer.parseInt(item.substring(start+1,end))>=Integer.parseInt(havenum)){
                                Toast.makeText(ReserveActivity.this, "예약인원이 가득 찼습니다.", Toast.LENGTH_SHORT).show();
                                ...
                                limitreference.addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        if (Integer.parseInt(dataSnapshot.getValue().toString())>=3){
                                            Toast.makeText(ReserveActivity.this, item.substring(0,11)+"에 예약된 부스가 3개이상 입니다. 내 예약에서 예약을 관리해주세요.", Toast.LENGTH_SHORT).show();
                ...
                cancell_reservereference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (myreservetime.contains("예약대기중")){
                            ...
                            Toast.makeText(ReserveActivity.this, "예약된 시간이 없습니다.", Toast.LENGTH_SHORT).show();
