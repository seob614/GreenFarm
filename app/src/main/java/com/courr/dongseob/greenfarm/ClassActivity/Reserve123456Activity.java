...
public class Reserve123456Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reserve123456);
        ...
        reservenumreference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                String B_num = dataSnapshot.child("2시~2시30분").child("인원").getValue().toString();
                String C_num = dataSnapshot.child("2시30분~3시").child("인원").getValue().toString();
                String D_num = dataSnapshot.child("3시~3시30분").child("인원").getValue().toString();
                String E_num = dataSnapshot.child("3시30분~4시").child("인원").getValue().toString();
                String F_num = dataSnapshot.child("4시~4시30분").child("인원").getValue().toString();

                Set<String> set = new LinkedHashSet<>();

                set.add("오후 1시30분~2시"+"("+A_num+"/"+havenum+")");
                set.add("오후 2시~2시30분"+"("+B_num+"/"+havenum+")");
                set.add("오후 2시30분~3시"+"("+C_num+"/"+havenum+")");
                set.add("오후 3시~3시30분"+"("+D_num+"/"+havenum+")");
                set.add("오후 3시30분~4시"+"("+E_num+"/"+havenum+")");
                set.add("오후 4시~4시30분"+"("+F_num+"/"+havenum+")");
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                bt_reserve.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (item.isEmpty()){
                            Toast.makeText(Reserve123456Activity.this, "예약할 시간을 고르세요.", Toast.LENGTH_SHORT).show();
                        }
                        else{


                            if (Integer.parseInt(item.substring(start+1,end))>=Integer.parseInt(havenum)){
                                Toast.makeText(Reserve123456Activity.this, "예약인원이 가득 찼습니다.", Toast.LENGTH_SHORT).show();
                                ...
                                limitreference.addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        if (Integer.parseInt(dataSnapshot.getValue().toString())>=3){
                                            Toast.makeText(Reserve123456Activity.this, item.substring(0,11)+"에 예약된 부스가 3개이상 입니다. 내 예약에서 예약을 관리해주세요.", Toast.LENGTH_SHORT).show();
                ...
                cancell_reservereference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (myreservetime.contains("예약대기중")){
                            ...
                            Toast.makeText(Reserve123456Activity.this, "예약된 시간이 없습니다.", Toast.LENGTH_SHORT).show();
