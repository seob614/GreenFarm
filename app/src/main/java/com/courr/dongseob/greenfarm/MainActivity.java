...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (s_studentnum != null) {
            Intent go_intent = new Intent(MainActivity.this, Menu.class);
        ...
        bt_go.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (studentnum.length()==9&& studentnum.substring(0,2).contains("20") && name!= null) {
                    ...
                    Intent intent = new Intent(MainActivity.this, UseExplainActivity.class);
                    ...
                    Toast.makeText(MainActivity.this, "정보를 제대로 입력해주십시오.", Toast.LENGTH_SHORT).show();
                }
            }
        });
